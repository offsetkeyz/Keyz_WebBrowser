...
namespace WebBrowser.UI {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class HistoryRow : global::System.Data.DataRow {
            ...
            public string Title {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Title\' in table \'History\' is DBNull.", e);
                    }
                }
                set {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsTitleNull() {
                return this.IsNull(this.tableHistory.TitleColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetTitleNull() {
                this[this.tableHistory.TitleColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WebBrowser.UI.Database1DataSetTableAdapters {
    ...
    public partial class BookmarksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Bookmarks] WHERE (([Id] = @Original_Id) AND ([URL] = @Original" +
                "_URL) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title" +
                ")))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Bookmarks] ([URL], [Title]) VALUES (@URL, @Title);\r\nSELECT Id," +
                " URL, Title FROM Bookmarks WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Bookmarks] SET [URL] = @URL, [Title] = @Title WHERE (([Id] = @Origi" +
                "nal_Id) AND ([URL] = @Original_URL) AND ((@IsNull_Title = 1 AND [Title] IS NULL)" +
                " OR ([Title] = @Original_Title)));\r\nSELECT Id, URL, Title FROM Bookmarks WHERE (" +
                "Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WebBrowser.UI.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, URL, Title FROM dbo.Bookmarks";
        ...
        public virtual int Fill(Database1DataSet.BookmarksDataTable dataTable) {
        ...
        public virtual Database1DataSet.BookmarksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.BookmarksDataTable dataTable = new Database1DataSet.BookmarksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.BookmarksDataTable dataTable) {
    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[History] WHERE (([Id] = @Original_Id) AND ([URL] = @Original_U" +
                "RL) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title))" +
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[History] ([URL], [Title], [Date]) VALUES (@URL, @Title, @Date)" +
                ";\r\nSELECT Id, URL, Title, Date FROM History WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@URL", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "URL", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[History] SET [URL] = @URL, [Title] = @Title, [Date] = @Date WHERE (([Id] = @Original_Id) AND ([URL] = @Original_URL) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ([Date] = @Original_Date));
SELECT Id, URL, Title, Date FROM History WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, URL, Title, Date FROM dbo.History";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
